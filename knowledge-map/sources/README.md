# sources · 知识地图的侦察原件（provenance）

`data.js` 的 Ⅰ 层内容综合自 2026-07-10 五路并行 subagent 侦察 + 一路补充考证，本目录存原始报告。

**用途**：未来仓库机制演化后，重跑同样的侦察 prompt，与这里的原件 diff，即可定位 `data.js` 需要更新的节点——没有原件就没有 diff 基准。
...
| `06-papers-supplement.md` | 补充 6 篇考证（含一处作者纠错） | 强制 WebSearch 逐条验证 |
