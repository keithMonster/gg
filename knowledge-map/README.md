...
> **快照件**（2026-07-10 建，2026-09-02 设计会话定性）：Ⅰ 层「gg 机制」节点按 07-10 状态绘制，此后机制已演化（三相→四相 / archive-format 与 personas·reasoning_modules 退役 / 视图拆两层 / 探索降频）——**以仓内文件为准，本图不随机制逐次刷新**；需要再生时按下方「再生成路径」整体重跑。
