...
Read（用 Read 工具，不用 cat）/Users/xuke/githubProject/gg/KERNEL.md → CORE.md → memory/state.md → memory/consolidation/essence-view.md（essence 当前有效视图常驻层；某滴全文按视图 / essence-index.md 指针回原卷；不载原卷全文、不载 tracks/keith.md 全文，2026-09-02 起）→ exploration.md，然后按 exploration.md 行动。
